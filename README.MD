...
- **BusRabbitMQ.API**: Servicios que interactúan con RabbitMQ (`ContextoConexionRabbit`, `FabricaConexionRabbit`, `ServicioColaRabbit`) y controladores (`ColasController`) expuestos en Swagger.
